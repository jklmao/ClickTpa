...
// Add tp bypass command so players can add friends
...
public class CommandTpa implements CommandExecutor, TabCompleter, ConfigUtil {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (!p.hasPermission("clicktpa.bypassworld.*")) {
			for (String worldName : clicktpa.getConfig().getStringList("Blacklisted-worlds")) { // Get list of all blacklisted worlds
				String targetWorld = target.getWorld().getName(); // Get targetworld name
